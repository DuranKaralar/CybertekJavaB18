 ...
 */
      ...
      char[] arr=str.toCharArray();
        ...
        /*    boolean isDigit =each >=48&&each<=57;
            if(isDigit){// if each is digit, we will convert to int and add to sum
        ...
        boolean a=Character.isAlphabetic('A'); //identifies if the given character is alphabet or not
